                ...
                <Link href={src || '/'}>
...

                    {
                        icon ?
                            ...
                            <svg id="Button_-_Corporate_Brochure" data-name="Button - Corporate Brochure" width="244" height="44" viewBox="0 0 244 44">
                                <g id="Rectangle_492" data-name="Rectangle 492" fill="none" stroke={`${color ? color : 'white'}`} stroke-width="1" opacity="0.5">
                                    <rect width="244" height="44" rx="22" stroke="none"/>
                                    <rect x="0.5" y="0.5" width="243" height="43" rx="21.5" fill="none"/>
                                </g>
                                <g id="Group_19461" data-name="Group 19461" transform="translate(-124 -328)">
                                    <text id="Corporate_Borchure" data-name="Corporate Borchure" transform="translate(187 355)" fill={`${color ? color : 'white'}`} font-size="16" font-family="Avenir-Medium, Avenir" font-weight="500"><tspan x="0" y="0">Corporate Borchure</tspan></text>
