...
const MyComponent = ({data, popup, bg,des,padding}) => {
                                ...
                                popup ?
                                    ...
                                    <Col md={{span: 5}}>
                                        ...
                                        </div>
                                        {
                                            ...
                                            <Title noanim margin={'40px 0 0 0'} text={data?.section_data?.short_desc}/>
