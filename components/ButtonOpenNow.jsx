                    ...
                    <a>
                        {
                            icon ?
                                ...
                                <svg id="Button_-_Open_an_Account_Now_2" data-name="Button - Open an Account Now 2" width="256" height="44" viewBox="0 0 256 44">
                                    ...
                                    <g id="Rectangle_493" data-name="Rectangle 493" fill="none" stroke={`${color ? color : 'white'}`} stroke-width="1" strokeDasharray="1 520" opacity="0">
                                        <rect width="256" height="44" rx="22" stroke="none"/>
                                        <rect x="0.5" y="0.5" width="255" height="43" rx="21.5" fill="none"/>
                                    </g>
                                    <g id="Group_4825" data-name="Group 4825" transform="translate(36 12)">
                                        <text id="Open_an_Account_Now" data-name="Open an Account Now" transform="translate(0 15)" fill={`${color ? color : 'white'}`} font-size="16" font-family="Avenir-Medium, Avenir" font-weight="500">
                                ...
                                <svg id="Button_-_Open_an_Account_Now" data-name="Button - Open an Account Now" xmlns="http://www.w3.org/2000/svg" width="238" height="44" viewBox="0 0 238 44">
                                    ...
                                    <text id="Open_an_Account_Now" data-name="Open an Account Now" transform="translate(36 27)" fill="#fff" font-size="16" font-family="Avenir-Medium, Avenir" font-weight="500">
                                        <tspan x="0" y="0">{text}</tspan>
                                    </text>
                                </svg>
