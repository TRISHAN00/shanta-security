...
const PopupFeedback = ({
    ...
    const onSubmit = (e) => {
        ...
        setValue(popupdata?.file?.list?.[0]?.full_path)

        var formData = new FormData();
        formData.append('email', e?.email);
        formData.append('form_id', 'shanta-financial-literacy-program');
        formData.append('course_name', popupdata?.data?.title);
        formData.append('file_link', popupdata?.file?.list?.[0]?.full_path);
                                                                ...
                                                                <Form className={'form'}  onSubmit={handleSubmit(onSubmit,onError)}>
                                                                    ...
                                                                    <div className="form-group">
                                                                        ...
                                                                        <Form.Group controlId="formBasicEmail">
                                                                            ...
                                                                            <Form.Control  name={'file_link'}
                                                                                           type="text"
                                                                                           hidden value={popupdata?.file?.list?.[0]?.full_path?popupdata?.file?.list?.[0]?.full_path:''}/>
                                                                        </Form.Group>
